...
import build.krema.core.ports.WindowPort;
 ...
 *
 * @deprecated Use {@link WindowPort} instead. This interface is maintained
 *             for backward compatibility and will be removed in a future version.
 * @see WindowPort
 */
@Deprecated(since = "2.0", forRemoval = true)
public interface WindowEngine extends WindowPort {
